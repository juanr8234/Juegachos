...
export class Hud {
  ...
  constructor(container: HTMLElement, onActivate: () => void) {
    ...
    this.hintEl.textContent = "← → / A D / arrastra para rotar la torre";
    ...
    // Make clicks/taps on overlays trigger activation
  ...
  setScore(score: number): void {
    ...
    // Add a little pop effect on score update
  ...
  showStart(): void {
    this.titleEl.textContent = "HELIX JUMP";
    this.subtitleEl.textContent = "presiona ENTER o arrastra para girar";
