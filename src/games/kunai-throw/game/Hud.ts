...
export class Hud {
  ...
  constructor(container: HTMLElement, onStartClick: () => void) {
    ...
    hud.append(this.scoreEl, this.bestEl, this.levelEl);
  ...
  showStart(): void {
    ...
    this.hintEl.innerHTML = `
      Controles:<br>
      <span class="overlay__hint-keys">Espacio</span> o <span class="overlay__hint-keys">Toque</span> : Arrojar kunai<br>
  ...
  showGameOver(score: number, best: number): void {
    ...
    this.subtitleEl.textContent = "UN KUNAI GOLPEÓ A OTRO";
    ...
    this.hintEl.innerHTML = "Presiona ENTER, haz clic o toca para volver a jugar";
    this.overlayEl.classList.remove("hidden");
  }
